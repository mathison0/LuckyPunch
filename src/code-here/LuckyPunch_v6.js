...
// 있을 곳의 반대편"을 노린다. v5의 예측 수비는 커밋 변위가 커서 이
// 공격에 특히 취약하다.
//
...
var CONTACT_GAIN = 15; // 늦은 접촉이 이만큼 더 좋으면 늦춘다
// v4·v5의 60은 전지적 수비수 모델 하에서의 값이다 — 그 모델에선 늦은 접촉의
// 이득이 과소평가돼 크게 잡아야 안전했다. 커밋+반응 모델은 접촉 시점별 가치를
// 제대로 재므로 15로 낮추는 것이 전 상대에서 우세였다 (v5 상대 55%→85~95%).
